...
type QuerySpendableBalancesResponse struct {
	...
	Balances  github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=balances,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"balances"`
	QueryTime int64                                    `protobuf:"varint,2,opt,name=query_time,json=queryTime,proto3" json:"query_time,omitempty"`
	// pagination defines the pagination in the response.
...
func (m *QuerySpendableBalancesResponse) GetQueryTime() int64 {
	if m != nil {
		return m.QueryTime
	}
	return 0
...
var fileDescriptor_9c6fc1939682df13 = []byte{
	...
	,
}
...
func (m *QuerySpendableBalancesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.QueryTime != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.QueryTime))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Balances) > 0 {
...
func (m *QuerySpendableBalancesResponse) Size() (n int) {
	...
	if m.QueryTime != 0 {
		n += 1 + sovQuery(uint64(m.QueryTime))
	}
	if m.Pagination != nil {
		l = m.Pagination.Size()
		n += 1 + l + sovQuery(uint64(l))
