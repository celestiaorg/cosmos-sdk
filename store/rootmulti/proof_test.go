...
func TestVerifyIAVLStoreQueryProof(t *testing.T) {
	...
	db := dbm.NewMemDB()
	iStore, err := iavl.LoadStore(db, log.NewNopLogger(), types.NewKVStoreKey("test"), types.CommitID{}, iavl.DefaultIAVLCacheSize, false, metrics.NewNoOpMetrics(), iavl.LoadStoreOptions{})
