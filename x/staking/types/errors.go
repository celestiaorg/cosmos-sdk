...
var (
	...
	ErrValidatorOrchestratorAddressExists = sdkerrors.Register(ModuleName, 5, "validator already exist for this orchestrator address; must use new validator orchestrator address")
	ErrValidatorEthereumAddressExists     = sdkerrors.Register(ModuleName, 5, "validator already exist for this ethereum address; must use new validator ethereum address")
