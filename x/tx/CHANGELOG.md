...
* [#747](https://github.com/celestiaorg/cosmos-sdk/pull/747) Reject `TxRaw` bytes that repeat `body_bytes` (field 1) or `auth_info_bytes` (field 2). Only `signatures` (field 3) may appear more than once.
