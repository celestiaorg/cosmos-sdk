...
type Keeper struct {
	...
	// UserOutstandingRewards is a map of automatically withdrawn rewards
	// yet to be claimed by the user.
	UserOutstandingRewards collections.Map[collections.Pair[sdk.AccAddress, sdk.ValAddress], types.UserOutstandingRewards]
